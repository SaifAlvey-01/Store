...
export default function PaymentMethodModal({ isOpen, onClose, onPayNow }) {
  const [paymentSuccess, setPaymentSuccess] = useState(false);

  const paymentMethods = [
    { imageUrl: "/stripe.png", title: "Image 1" },
    { imageUrl: "/paypal.png", title: "Image 2" },
    { imageUrl: "/phonepe.png", title: "Image 3" },
    { imageUrl: "/UPI.png", title: "Image 3" },
  ];
    ...
    >
      <div className="relative p-4 w-full max-w-md max-h-full">
        ...
        >
          ...
          <div className="flex flex-row w-full box-border mt-4 mb-6">
            {paymentMethods.map((item, index) => (
              <div
                key={index}
                className="flex-shrink-0 bg-[#E9F4FF] rounded-[18px] mx-2.5 w-14 h-14 flex items-center justify-center p-2.5"
              >
                <img
                  src={item.imageUrl}
          ...
          <h3 className="font-freesans mb-2 mx-1.5 text-[12px] text-[#4B4B4B] font-[700]">
            Payment Summary
          </h3>
