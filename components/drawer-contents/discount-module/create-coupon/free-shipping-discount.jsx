...
export default function FreeShippingDiscount({ setShowSidebar }) {
  ...
  const radioOptions = [
    { id: "radio-1", label: "On every purchase" },
    { id: "radio-2", label: "Above certain amount" },
  ];
        ...
        <div className="mt-6">
          ...
          <div className="flex flex-row justify-between items-center mt-1">
            {radioOptions.map((option) => (
              <div
                key={option.id}
                className="flex items-center pr-6 border border-gray-200 rounded dark:border-gray-700"
              >
                <input
                  id={option.id}
                  type="radio"
