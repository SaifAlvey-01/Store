...
export default function BuyXGetYFreeDiscount({ setShowSidebar }) {
    ...
    <div className="flex flex-col h-screen">
      ...
      >
        ...
        <div className=" flex flex-col relative mt-6">
          ...
          />
          <span
            className="font-freesans absolute right-3 top-[78%] transform -translate-y-1/2"
            style={{
              color: "#4B5563",
              fontWeight: 500,
              fontSize: "14px",
        ...
        <div className="relative mt-6">
          ...
          <span
            className="font-freesans absolute right-3 top-[68%] transform -translate-y-1/2"
            style={{
              color: "#4B5563",
              fontWeight: 500,
              fontSize: "14px",
