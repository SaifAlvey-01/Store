...
export default function PercentageDiscount({ setShowSidebar }) {
  ...
  const radioOptions = [
    { id: "radio-1", label: "Order Value" },
    { id: "radio-2", label: "Order Quantity" },
  ];
    ...
    <div className="flex flex-col h-screen">
      ...
      >
        ...
        <div className=" flex flex-col relative mt-6">
          ...
          />
          <img
            src="/percent-dark.png"
            alt="Description"
            className="absolute right-3 top-[78%] transform -translate-y-1/2 w-4 h-4"
          />
        </div>
