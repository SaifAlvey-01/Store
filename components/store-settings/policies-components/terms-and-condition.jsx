...
export default function TermsAndCondition() {
  return (
    <div
      ...
      className="font-plusJakartaSans mt-2 pr-6"
    >
      These terms and conditions outline the rules and regulations for the use
      of ahmed akram's Website, located at mydukaan.io/ahmedakram. By accessing
      this website we assume you accept these terms and conditions. Do not
      continue to use mydukaan.io/ahmedakram if you do not agree to take all of
      the terms and conditions stated on this page. The following terminology
      ...
      in accordance with and subject to, prevailing law of Netherlands. Any use
      ...
      accessing mydukaan.io/ahmedakram, you agreed to use cookies in agreement
      with the ahmed akram's Privacy Policy. Most interactive websites use
      ...
      otherwise stated, ahmed akram and/or its licensors own the intellectual
      property rights for all material on mydukaan.io/ahmedakram. All
      intellectual property rights are reserved. You may access this from
      mydukaan.io/ahmedakram for your own personal use subjected to restrictions
      set in these terms and conditions. You must not: Republish material from
      mydukaan.io/ahmedakram Sell, rent or sub-license material from
      mydukaan.io/ahmedakram Reproduce, duplicate or copy material from
      mydukaan.io/ahmedakram Redistribute content from mydukaan.io/ahmedakram
      Parts of this website offer an opportunity for users to post and exchange
      opinions and information in certain areas of the website. ahmed akram does
      not filter, edit, publish or review Comments prior to their presence on
      the website. Comments do not reflect the views and opinions of ahmed
      akram, its agents and/or affiliates. Comments reflect the views and
      opinions of the person who post their views and opinions. To the extent
      permitted by applicable laws, ahmed akram shall not be liable for the
      ...
      Comments on this website. ahmed akram reserves the right to monitor all
      ...
      activities or unlawful activity. You hereby grant ahmed akram a
      ...
      long as the link: is not in any way deceptive; does not falsely imply
      sponsorship, endorsement or approval of the linking party and its products
      and/or services; and fits within the context of the linking party’s site.
      ...
      if we decide that: the link would not make us look unfavorably to
      ourselves or to our accredited businesses; the organization does not have
      any negative records with us; the benefit to us from the visibility of the
      hyperlink compensates the absence of ahmed akram; and the link is in the
      context of general resource information. These organizations may link to
      our home page so long as the link: is not in any way deceptive; does not
      falsely imply sponsorship, endorsement or approval of the linking party
      and its products or services; and fits within the context of the linking
      party’s site. If you are one of the organizations listed in paragraph 2
      above and are interested in linking to our website, you must inform us by
      sending an e-mail to ahmed akram. Please include your name, your
      ...
      for a response. Approved organizations may hyperlink to our Website as
      follows: By use of our corporate name; or By use of the uniform resource
      locator being linked to; or By use of any other description of our Website
      being linked to that makes sense within the context and format of content
      on the linking party’s site. No use of ahmed akram's logo or other artwork
      will be allowed for linking absent a trademark license agreement. iFrames
      ...
      Your Privacy Please read Privacy Policy Reservation of Rights We reserve
      ...
      upon request. We also reserve the right to amen these terms and conditions
      ...
      conditions. Removal of links from our website If you find any link on our
      Website that is offensive for any reason, you are free to contact and
      inform us any moment. We will consider requests to remove links but we are
      not obligated to or so or to respond to you directly. We do not ensure
      ...
      this Section and elsewhere in this disclaimer: are subject to the
      preceding paragraph; and govern all liabilities arising under the
