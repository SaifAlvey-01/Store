...
import CouponsListing from "../inner-pages/coupons-listing";

export default function Discounts({
  showDiscountCoupons,
  setShowDiscountCoupons,
}) {
  return (
    <>
      {showDiscountCoupons ? (
          ...
          >
            <div className="flex flex-col items-center justify-between ">
              ...
              <div className="flex flex-col items-center justify-between ">
                ...
                >
                  Now you can create and share coupons for your store to get
                  more and more orders on your store.{" "}
                </p>
              </div>

              <button
                onClick={() => setShowDiscountCoupons(true)}
