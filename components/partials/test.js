                          ...
                          style={{
                            color:
                              activeGroup === "dashboard"
                                ? "#1F1D2B"
                                : "#FAFAFA",
                            fontWeight: activeGroup === "dashboard" ? 500 : 400,
                            marginLeft: 14,
                          }}
                        >
                          Dashboard
                        ...
                        <div className="flex flex-row items-center">
                          ...
                          >
                            <path
                              ...
                              stroke={
                                activeGroup === "orders" ? "#1F1D2B" : "#FAFAFA"
                              }
                              strokeWidth="1.5"
                            />
                            <path
                            ...
                            style={{
                              color:
                                activeGroup === "orders"
                                  ? "#1F1D2B"
                                  : "#FAFAFA",
                              fontWeight: activeGroup === "orders" ? 500 : 400,
                              marginLeft: 14,
                            }}
                          >
                            Orders
              ...
              >
                <li
                  className={`w-full px-4 py-2 mb-1 border-b border-gray-200 rounded-t-lg dark:border-gray-600 ${
                    router.pathname === "/orders/all-orders" ? "font-bold" : ""
                  }`}
                >
                  {" "}
                  <Link
                      ...
                      <div className="flex flex-row items-center">
                        ...
                        >
                          <path
                            ...
                            fill={
                              activeGroup === "delivery" ? "#1F1D2B" : "#FAFAFA"
                            }
                          />
                          <path
                          ...
                          style={{
                            color:
                              activeGroup === "delivery"
                                ? "#1F1D2B"
                                : "#FAFAFA",
                            fontWeight: activeGroup === "delivery" ? 500 : 400,
                            marginLeft: 14,
                          }}
                        >
                          Delivery
          ...
          <div className="mb-2" ref={productsRef}>
            ...
            {activeGroup === "products" && (
              ...
              >
                ...
                <li
                  className={`w-full px-4 py-2 mb-1 border-b border-gray-200 rounded-t-lg dark:border-gray-600 ${
                    router.pathname === "/products/inventory" ? "font-bold" : ""
                  }`}
                >
                  <Link
                    onClick={(e) =>
          ...
          <div className="mb-2" ref={analyticsRef}>
            ...
            {analyticsSubLinksVisible && (
              ...
              >
                <li
                  className={`w-full px-4 py-2 mb-1 border-b border-gray-200 rounded-t-lg dark:border-gray-600 ${
                    router.pathname === "/analytics/sales" ? "font-bold" : ""
                  }`}
                >
                  {" "}
                  <Link
                ...
                <li
                  className={`w-full px-4 py-2 mb-1 border-b border-gray-200 rounded-t-lg dark:border-gray-600 ${
                    router.pathname === "/analytics/traffic" ? "font-bold" : ""
                  }`}
                >
                  <Link
                    onClick={(e) =>
                ...
                <li
                  className={`w-full px-4 py-2 mb-1 border-b border-gray-200 rounded-t-lg dark:border-gray-600 ${
                    router.pathname === "/analytics/products" ? "font-bold" : ""
                  }`}
                >
                  <Link
                    onClick={(e) =>
                      ...
                      <div className="flex flex-row items-center">
                        ...
                        >
                          <path
                            ...
                            stroke={
                              activeGroup === "payments" ? "#1F1D2B" : "#FAFAFA"
                            }
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          ...
                          style={{
                            color:
                              activeGroup === "payments"
                                ? "#1F1D2B"
                                : "#FAFAFA",
                            fontWeight: activeGroup === "payments" ? 500 : 400,
                            marginLeft: 14,
                          }}
                        >
                          Payments
                          ...
                          style={{
                            color:
                              activeGroup === "discounts"
                                ? "#1F1D2B"
                                : "#FAFAFA",
                            fontWeight: activeGroup === "discounts" ? 500 : 400,
                            marginLeft: 14,
                          }}
                        >
                          Discounts
                      ...
                      <div className="flex flex-row items-center">
                        ...
                        >
                          <path
                            ...
                            stroke={
                              activeGroup === "audience" ? "#1F1D2B" : "#FAFAFA"
                            }
                            strokeWidth="1.2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          ...
                          style={{
                            color:
                              activeGroup === "audience"
                                ? "#1F1D2B"
                                : "#FAFAFA",
                            fontWeight: activeGroup === "audience" ? 500 : 400,
                            marginLeft: 14,
                          }}
                        >
                          Audience
                      ...
                      <div className="flex flex-row items-center">
                        ...
                        >
                          <path
                            ...
                            stroke={
                              activeGroup === "builder" ? "#1F1D2B" : "#FAFAFA"
                            }
                            strokeWidth="1.2"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                        ...
                        <span
                          style={{
                            color:
                              activeGroup === "builder" ? "#1F1D2B" : "#FAFAFA",
                            fontWeight: activeGroup === "builder" ? 500 : 400,
                            marginLeft: 14,
                          }}
                        >
                          Builder
          ...
          <div className="mb-2" ref={appearanceRef}>
            ...
            {appearanceSubLinksVisible && (
              ...
              >
                <li
                  className={`w-full px-4 py-2 mb-1 border-b border-gray-200 rounded-t-lg dark:border-gray-600 ${
                    router.pathname === "/appearance/themes" ? "font-bold" : ""
                  }`}
                >
                  {" "}
                  <Link
                ...
                <li
                  className={`w-full px-4 py-2 mb-1 border-b border-gray-200 rounded-t-lg dark:border-gray-600 ${
                    router.pathname === "/appearance/pages" ? "font-bold" : ""
                  }`}
                >
                  <Link
                    onClick={(e) =>
                ...
                <li
                  className={`w-full px-4 py-2 mb-1 border-b border-gray-200 rounded-t-lg dark:border-gray-600 ${
                    router.pathname === "/appearance/menu" ? "font-bold" : ""
                  }`}
                >
                  <Link
                    onClick={(e) =>
                ...
                <li
                  className={`w-full px-4 py-2 mb-1 border-b border-gray-200 rounded-t-lg dark:border-gray-600 ${
                    router.pathname === "/appearance/blogs" ? "font-bold" : ""
                  }`}
                >
                  <Link
                    onClick={(e) =>
                ...
                <li
                  className={`w-full px-4 py-2 mb-1 border-b border-gray-200 rounded-t-lg dark:border-gray-600 ${
                    router.pathname === "/appearance/media" ? "font-bold" : ""
                  }`}
                >
                  <Link
                    onClick={(e) =>
                      ...
                      <div className="flex flex-row items-center">
                        ...
                        >
                          <path
                            ...
                            fill={
                              activeGroup === "tools" ? "#1F1D2B" : "#FAFAFA"
                            }
                          />
                        </svg>
                        <span
                          ...
                          style={{
                            color:
                              activeGroup === "settings"
                                ? "#1F1D2B"
                                : "#FAFAFA",
                            fontWeight: activeGroup === "settings" ? 500 : 400,
                            marginLeft: 14,
                          }}
                        >
                          Settings
                      ...
                      <div className="flex flex-row items-center">
                        ...
                        >
                          <path
                            ...
                            stroke={
                              activeGroup === "sign-out" ? "#1F1D2B" : "#FAFAFA"
                            }
                            strokeWidth="1.5"
                            strokeLinecap="round"
                            strokeLinejoin="round"
                          ...
                          style={{
                            color:
                              activeGroup === "sign-out"
                                ? "#1F1D2B"
                                : "#FAFAFA",
                            fontWeight: activeGroup === "sign-out" ? 500 : 400,
                            marginLeft: 14,
                          }}
                        >
                          Sign Out
