        ...
        <div className="flex flex-col items-center justify-start gap-[20px]">
          ...
          <div className=" w-full text-neutral-600">
            ...
            >
              ...
              <button
                type="submit"
                className="rounded bg-primary-300-main w-full flex flex-col p-2.5 box-border items-center justify-center cursor-pointer text-center text-base text-white"
              >
