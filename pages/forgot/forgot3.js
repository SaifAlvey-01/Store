    ...
    <>
      {isLoading ? (
        ...
        <div
          ...
          className="rounded-3xl bg-white shadow-[2px_4px_6px_rgba(75,_85,_99,_0.06)]  overflow-hidden flex flex-row py-10 px-2.5 mx-2 items-start justify-start border-[0.8px] border-solid border-gainsboro"
        >
          <div className="flex flex-col ">
            <div className="flex flex-col items-center justify-start gap-[18px]">
              ...
              <form onSubmit={handleFormSubmit}>
                <div className="w-[340px] flex flex-col  gap-[4px] mb-12">
                ...
                <button
                  type="submit"
                  className="rounded bg-primary-300-main w-[340px] mb-6 flex flex-col p-2 box-border items-center justify-center cursor-pointer text-center text-base text-white"
                >
              ...
              <div className="relative text-sm tracking-[0.25px] leading-[20px] text-center text-darkslategray font-roboto  mt-8">
                <span>
