...
const dashboard3 = ({ setCurrentStep, currentStep }) => {
  ...
  return (
    <div className="flex justify-center relative content-center align-center self-center items-center w-screen h-full">
      <div className={`w-[508px] h-[545px] visible object-center rounded-[24px] shadow border-slate-200 bg-white ${opc == 1 ? "visible" : "hidden"}`}>
        <div className="p-[24px]">
          <div className="flex justify-between mx-2"><p className="text-[20px] font-semibold font-freesans mt-[-1px]">Withdraw Funds</p>
            <svg className="cursor-pointer" onClick={() => setOpc(0)} width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <p className="text-[12px] md:ml-[120px] w-full">You must need 100$ to withdraw amount</p>
          ...
          <div className="mt-5">
            ...
            <div className="relative mx-auto">
              ...
              />
              <svg className="absolute top-0 mt-[9px] mr-[12px] right-0" width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M8.66992 14.8298C8.66992 16.1198 9.65992 17.1598 10.8899 17.1598H13.3999C14.4699 17.1598 15.3399 16.2498 15.3399 15.1298C15.3399 13.9098 14.8099 13.4798 14.0199 13.1998L9.98992 11.7998C9.19992 11.5198 8.66992 11.0898 8.66992 9.86984C8.66992 8.74984 9.53992 7.83984 10.6099 7.83984H13.1199C14.3499 7.83984 15.3399 8.87984 15.3399 10.1698" stroke="#767783" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M12 6.5V18.5" stroke="#767783" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M2 9.5C2 4.5 4 2.5 9 2.5H15C20 2.5 22 4.5 22 9.5V15.5C22 20.5 20 22.5 15 22.5H9C4 22.5 2 20.5 2 15.5V13.53" stroke="#767783" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </div>
          </div>
          <div className="mt-5">
            ...
            <div className="relative mx-auto">
              <input
                ...
                className={`h-[14px] w-[420px] mt-[-8px] rounded-[8px] pl-5 ring-1 ring-inset ring-gray-300 focus:ring-[#4162FF] focus:border-[#b3c0ff] focus:outline-none focus:ring-1 border-slate-300  self-stretch bg-white flex flex-row  py-3.5 px-4 items-center justify-start text-[#4B4B4B] font-roboto border-[1.5px] border-solid md:border-gainsboro `}
              />
              <svg className="absolute top-0 mt-[12px] mr-[14px] right-0" width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M14.9396 7.21289L10.0496 12.1029C9.47207 12.6804 8.52707 12.6804 7.94957 12.1029L3.05957 7.21289" stroke="#767783" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
              </svg>

            </div>
            <p className="text-[#3A70E2] text-[12px]">Add Another Bank Account</p>
          </div>
      ...
      <div
        style={{ backgroundColor: "#F7F9FB" }}
        className={`flex h-screen overflow-hidden ${opc == 1 ? "opacity-20" : "opacity"}`}
      >
        <Sidebar
                ...
                <div>
                  <div className="flex-col shadow font-freesans bg-white border-b mx-5 border-slate-200 rounded-lg mt-[-25px] h-[600px] w-full">
                    <div className="py-[24px] flex">
                      ...
                      <div onClick={() => setOpc(1)} className="items-center h-[94px] flex ml-[24px] w-[344px] shadow bg-[#f7f9ff] border-solid border-l-4 rounded-[16px] border-[#9a6aff] justify-between">
                    ...
                    <div className="flex absolute mr-[55px] right-0 pt-7">
                      ...
                      <div onClick={() => setOpc(1)} className="mx-2 justify-center cursor-pointer w-[162px] h-[36px] rounded-md flex items-center border-2 bg-[#4162ff] border-[#4162ff] border-solid text-white">
