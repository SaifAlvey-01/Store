  ...
  return (
    <div>
      <div
        ...
        className={`m-6 relative rounded-lg top-0 shadow flex ${check == 0? "h-[46px]":"h-[136px]"} bg-white border-b border-slate-200`}
      >
        <p className="text-[16px] font-freesans  ml-5 content-center">{ques}</p>
        {check == 0 ? (
          <svg
            className="w-[24px] h-[25px] absolute right-0 mr-3 mt-2.5"
            viewBox="0 0 24 25"
            fill="none"
          ...
          <svg
            className="w-[24px] h-[25px] absolute  mt-2.5 right-0 mr-3"
            viewBox="0 0 24 25"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
          >
