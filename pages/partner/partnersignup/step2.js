...
function step2({ setCurrentStep, setFormData, email }) {
  ...
  return (
      ...
      <div className='bg-[#E9F2FF] flex w-[368px] h-[455px] xl:w-[1240px] xl:h-[686px] rounded-[32px]'>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='bg-white w-[368px] h-[455px] xl:h-[686px] xl:w-[400px] flex content-center rounded-[32px]'>
