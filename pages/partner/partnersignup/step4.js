...
const sign4 = ({ setloading, setCurrentStep }) => {
  ...
  return (
    <div className="bg-[url('/partner_assets/bg-gradient.svg')] justify-center items-center w-screen h-screen flex">
      <div className="bg-[#E9F2FF] flex w-[398px] h-[475px] lg:w-[1240px] lg:h-[686px] rounded-[32px]">
        ...
        <div className="bg-white w-[398px] h-[475px] lg:h-[686px] lg:w-[400px] flex content-center rounded-[32px]">
          <div className="my-[24px] mx-[32px] lg:my-[137px] lg:mx-[32px] ">
            ...
            <p className="text-[#374151] pt-5">Enter Your Name</p>
            <input
              type="text"
            ...
            <div
              className={`text-[16px] cursor-pointer flex justify-center items-center font-normal leading-[24px] h-[44px] w-[333px] mt-4 rounded ${
