...
function step3({ setCurrentStep }) {
  ...
  return (
    <div className="bg-[url('/partner_assets/bg-gradient.svg')] justify-center items-center w-screen h-screen flex">
      <div className="bg-[#E9F2FF] flex w-[396px] h-[575px] lg:w-[1240px] lg:h-[686px] rounded-[32px]">
        ...
        <div className="bg-white w-[396px] h-[575px] lg:h-[686px] lg:w-[400px] flex content-center rounded-[32px]">
