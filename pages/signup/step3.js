    ...
    <div className=" w-full sm:w-[450px] md:w-[450px] lg:w-[450px] min-h-[calc(100% - 100px)] text-11xl text-neutral-600">
      <div className="rounded-3xl bg-white shadow-[2px_4px_6px_rgba(75,_85,_99,_0.06)] overflow-hidden mx-2 py-8 px-2 items-center justify-center border-[0.8px] border-solid border-gainsboro">
        <div className="flex flex-col items-center justify-center gap-[14px]">
          ...
          <div className="flex w-full flex-col items-center justify-center text-base text-neutral-500">
            <div className="flex w-full flex-col items-center justify-start gap-[24px]">
              ...
              <div className="w-full flex flex-col items-center justify-center  gap-[4px] cursor-pointer text-sm text-dimgray">
                ...
                <div className="w-full flex flex-row items-center justify-center  gap-[4px] cursor-pointer text-sm text-dimgray">
