                    ...
                    <div className="flex flex-col items-start justify-start gap-[28px]">
                      ...
                      >
                        ...
                        <div className="w-[360px] flex flex-row items-start justify-between">
                          <div className="rounded-lg bg-white box-border w-11 flex flex-row py-2.5 px-4 items-center justify-start border-[1.5px] border-solid border-gainsboro">
                      ...
                      <div className="rounded bg-primary-100 w-[360px] flex flex-col p-2 box-border items-center justify-center text-center text-white font-poppins">
